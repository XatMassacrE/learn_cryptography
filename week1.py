...
cm = '32510ba9babebbbefd001547a810e67149caee11d945cd7fc81a05e9f85aac650e9052ba6a8cd8257bf14d13e6f0a803b54fde9e77472dbff89d71b57bddef121336cb85ccb8f3315f4b52e301d16e9f52f904'
...
def print_character_xor():
    lc = string.ascii_lowercase
    uc = string.ascii_uppercase
    s = lc + uc
    for i in range(len(s)):
        for j in range(i, len(s)):
            r = hex(ord(s[i]) ^ ord(s[j]))
            print(r)
...
if __name__ == '__main__':
    ...
    cm = codecs.decode(cm, 'hex')
    cm = cm.decode('unicode_escape')
    print(cm)
